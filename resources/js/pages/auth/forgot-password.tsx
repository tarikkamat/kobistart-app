...
export default function ForgotPassword({ status }: { status?: string }) {
    return (
        <AuthLayout title="Kobistart | Şifremi Unuttum">
            ...
            <div className="relative w-full max-w-md">
                ...
                <GlassCard className="relative z-10 animate-in rounded-3xl border-white/40 bg-white/40 p-8 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.15)] duration-1000 fade-in slide-in-from-bottom-8 sm:p-10 dark:border-white/10 dark:bg-white/5 dark:shadow-[0_32px_64px_-16px_rgba(0,0,0,0.4)]">
                    ...
                    <Form {...email.form()} className="flex flex-col gap-6">
                        {({ processing, errors }) => (
                            <>
                                ...
                                <div className="animate-in text-center text-sm text-muted-foreground delay-400 duration-1000 fade-in slide-in-from-bottom-8">
                                    Veya,{' '}
                                    <TextLink
                                        href={login()}
                    ...
                    <div className="mt-6 flex animate-in items-center justify-center gap-2 rounded-xl border border-blue-200 bg-blue-50 px-4 py-3 text-sm font-medium text-blue-600 delay-500 duration-700 fade-in slide-in-from-bottom-4 dark:border-blue-500/20 dark:bg-blue-500/10 dark:text-blue-400">
