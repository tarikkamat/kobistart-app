...
export default function ResetPassword({ token, email }: ResetPasswordProps) {
    return (
        <AuthLayout title="Kobistart | Şifremi Sıfırla">
                    ...
                    >
                        {({ processing, errors }) => (
                            <>
                                <div className="grid gap-6">
                                    <div className="grid animate-in gap-2 delay-200 duration-1000 fade-in slide-in-from-bottom-8">
                                        ...
                                        <Input
                                            ...
                                            value={email}
                                            readOnly
                                            className="h-12 cursor-not-allowed rounded-xl border-2 border-gray-200 bg-gray-50 text-gray-500 dark:border-white/10 dark:bg-slate-800/50 dark:text-gray-400"
                                        />
                                ...
                                <div className="mt-6 flex animate-in items-center justify-center gap-2 rounded-xl border border-blue-200 bg-blue-50 px-4 py-3 text-sm font-medium text-blue-600 delay-600 duration-700 fade-in slide-in-from-bottom-4 dark:border-blue-500/20 dark:bg-blue-500/10 dark:text-blue-400">
