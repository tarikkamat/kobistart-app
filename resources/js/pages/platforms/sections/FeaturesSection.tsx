        ...
        <div className="space-y-8">
            <div className="space-y-3">
                ...
                <p className="max-w-xl text-zinc-500 dark:text-zinc-400">
                    Tüm planlarda bulunan özellikleri kategori bazında
                    görüntüleyin.
                </p>
            </div>
                                    ...
                                    <table className="w-full">
                                        <thead>
                                            <tr className="border-b border-zinc-200 dark:border-zinc-700">
                                                ...
                                                {plans.map((plan) => (
                                                    <th
                                                        key={plan.id}
                                                        className="min-w-[120px] px-4 py-3 text-center text-sm font-semibold text-zinc-900 dark:text-zinc-50"
                                                    >
                                                        {plan.name}
                                                    </th>
                                                ))}
                                        ...
                                        <tbody>
                                            {features.map((feature) => {
                                                ...
                                                const firstPlanValue =
                                                    feature.plans.get(
                                                        firstPlan.id,
                                                    );
                                                const displayName =
                                                    firstPlanValue?.platformLabel ||
                                                    feature.featureName;
