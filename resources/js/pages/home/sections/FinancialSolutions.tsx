...
export default function FinancialSolutions() {
    return (
        <section className="py-12 bg-white dark:bg-[#020617]">
                ...
                <div className="relative">
                    ...
                    >
                        <CarouselContent className="-ml-4 md:-ml-6">
                            {solutions.map((item, index) => (
                                ...
                                >
                                    <a
                                        href={item.link}
                                        className="group relative flex flex-col overflow-hidden rounded-2xl border border-gray-100 bg-white transition-all hover:shadow-lg dark:border-white/10 dark:bg-white/5 h-full"
                                    >
                                        ...
                                        <div className="flex flex-1 flex-col p-6">
                                            <div className="mb-4 flex items-start justify-between gap-4">
                                                <h3 className="text-lg font-medium leading-snug text-gray-900 dark:text-white">
                                                    {item.title}
                                                </h3>
                        ...
                        <div className="hidden md:block">
                            <CarouselPrevious className="-left-4 bg-white dark:bg-zinc-900 border-gray-200 dark:border-white/10" />
                            <CarouselNext className="-right-4 bg-white dark:bg-zinc-900 border-gray-200 dark:border-white/10" />
                        </div>
                    </Carousel>
                </div>
            </div>
