        ...
        <section className="py-20 bg-slate-50 dark:bg-transparent">
            <div className="container mx-auto px-4">
                ...
                <div className="mx-auto max-w-5xl overflow-x-auto pb-4">
                    <GlassCard className="min-w-[700px] p-0 border-slate-200 bg-white dark:border-white/10 dark:bg-transparent">
                        <table className="w-full text-left text-sm">
                            <thead>
                                <tr className="border-b border-slate-200 dark:border-white/10">
                                    <th className="p-4 font-medium text-gray-500">Feature</th>
                                    <th className="p-4 font-bold text-gray-900 bg-blue-50 dark:text-white dark:bg-blue-900/20 w-[25%]">
                                        WooCommerce
                            ...
                            <tbody className="divide-y divide-slate-200 dark:divide-white/10">
                                <tr>
                                    ...
                                    <td className="bg-blue-50/50 p-4 font-bold text-green-600 dark:bg-blue-900/10">~$25</td>
                                ...
                                <tr>
                                    ...
                                    <td className="bg-blue-50/50 p-4 font-bold text-green-600 dark:bg-blue-900/10">0%</td>
                                ...
                                <tr>
                                    ...
                                    <td className="bg-blue-50/50 p-4 font-medium text-yellow-600 dark:bg-blue-900/10">Medium</td>
                                ...
                                <tr>
                                    ...
                                    <td className="bg-blue-50/50 p-4 font-bold text-green-600 dark:bg-blue-900/10">Unlimited</td>
                                ...
                                <tr>
                                    ...
                                    <td className="bg-blue-50/50 p-4 text-red-500 dark:bg-blue-900/10">Community</td>
