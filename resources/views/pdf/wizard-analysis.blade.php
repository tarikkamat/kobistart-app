...
<body>
        ...
        <div class="platform-header">
            <div class="platform-info">
                ...
                <div class="plan">Önerilen Plan: {{ $primary['recommendedPlan']['name'] }} - 
                    ${{ number_format($primary['recommendedPlan']['monthlyPrice'], 2) }}/{{ $primary['recommendedPlan']['currency'] === 'USD' ? 'ay' : $primary['recommendedPlan']['currency'] }}
                </div>
                @endif
    ...
    <div class="section" style="margin-top: 30px;">
        ...
        <div style="background: #f8fafc; padding: 12px; border-radius: 6px; margin-bottom: 10px; border-left: 3px solid #8b5cf6;">
            ...
            <p style="margin-top: 5px; color: #6366f1;">
                <strong>Yeni Öneri:</strong> {{ $scenario['newRecommendation']['platform']['name'] ?? 'Platform' }}
            </p>
            @endif
        </div>
        @endforeach
