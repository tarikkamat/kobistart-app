...
use App\Contracts\Comparison\ComparisonServiceInterface;
use App\Repository\Comparison\ComparisonRepository;
use Illuminate\Database\Eloquent\Collection;

class ComparisonService extends BaseService implements ComparisonServiceInterface
{
