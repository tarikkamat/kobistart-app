...
use App\Contracts\Wizard\WizardAnalysisRepositoryInterface;
use App\Models\WizardAnalysis;
use Illuminate\Database\Eloquent\Collection;

class WizardAnalysisRepository extends BaseRepository implements WizardAnalysisRepositoryInterface
{
