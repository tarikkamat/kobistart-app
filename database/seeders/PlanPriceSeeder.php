...
class PlanPriceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $planPrices = [
            ...
            // Ticimax Advance Plus (plan_id: 8)
            [
                'plan_id' => 8,
                'period' => 'monthly',
